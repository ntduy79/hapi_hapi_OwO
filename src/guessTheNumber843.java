...
public class guessTheNumber843 {
    import java.util.*;
    ...
    public class Solution {
        ...
        private String getBestGuess(String[] words) {
            ...
            for (String word1 : words) {
                ...
                for (String word2 : words) {
                    ...
                    int sim = match(word1, word2);
                    groups.put(sim, groups.getOrDefault(sim, 0) + 1);
                }
                int maxGroup = groups.values().stream().max(Integer::compareTo).orElse(0);
